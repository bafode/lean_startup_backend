...
favoriteSchema.plugin(plugins_1.toJSON);
favoriteSchema.plugin(plugins_1.paginate);
const Favorite = mongoose_1.default.model(types_1.EModelNames.FAVORITE, favoriteSchema);
